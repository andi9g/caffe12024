...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 rounded-lg">
    <!-- Brand Logo -->
    <a href="index3.html" class="brand-link">
      {{-- <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"> --}}
      <span class="brand-image mt-1 font-weight-light"><b>APLIKASI</b></span>
      <span class="brand-text font-weight-light"><b> CAFFE</b></span>
    </a>
